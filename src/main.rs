...
fn main()
{
  ...
  // oliver_fill_circle(&mut pixels, WIDTH, HEIGHT, WIDTH as i32 / 2 - 50, HEIGHT as i32 / 2  - 50, 50, GREEN);
  oliver_fill_rect(&mut pixels, WIDTH, HEIGHT, WIDTH as i32 / 2 - 50, HEIGHT as i32 / 2  - 50, 100, 100, BLUE);
...
fn checker_example(pixels: &mut [u32])
{
  for y in 0..ROWS
  {
    for x in 0..COLS
    {
      ...
      oliver_fill_rect(pixels, WIDTH, HEIGHT, x * COL_WIDTH, y * COL_HEIGHT, COL_WIDTH, COL_HEIGHT, color);
    }
  }
}
